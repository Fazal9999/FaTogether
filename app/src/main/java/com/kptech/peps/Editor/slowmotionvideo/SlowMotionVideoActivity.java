package com.kptech.peps.Editor.slowmotionvideo;
        ...
        FFmpeg.executeAsync(ffmpegCommand, new ExecuteCallback() {
            ...
            public void apply(final long executionId, final int returnCode) {
                ...
                if (returnCode == RETURN_CODE_SUCCESS) {
                    ...
                    Intent slowintent=new Intent(SlowMotionVideoActivity.this, CreateHomePostActivity.class);
                    slowintent.putExtra(Const.VIDEO,SlowMotionVideoActivity.this.b);
