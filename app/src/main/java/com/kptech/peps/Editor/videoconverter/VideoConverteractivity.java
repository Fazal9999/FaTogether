package com.kptech.peps.Editor.videoconverter;
...
public class VideoConverteractivity extends AppCompatActivity implements OnSeekBarChangeListener {
    ...
    private class a {
        ...
        public void b() {
            ...
            Intent coninten=new Intent(VideoConverteractivity.this, CreateHomePostActivity.class);
            coninten.putExtra(Const.VIDEO,VideoConverteractivity.a);
            startActivity(coninten);
        }
    }
