...
public class SelectImageAndMyVideoActivity extends AppCompatActivity {
    ...
    private void a(ViewPager viewPager) {
        ...
        aVar.a(new SelectImageFragment(), "CREATE STORY");
        aVar.a(new MyPhotoToVideoFragment(), "MY ALBUM");
