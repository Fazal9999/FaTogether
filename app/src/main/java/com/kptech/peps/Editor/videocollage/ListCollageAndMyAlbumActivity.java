...
public class ListCollageAndMyAlbumActivity extends AppCompatActivity {
    static final boolean a = true;
    private TabLayout b;
    private ViewPager c;
    private int[] d = {R.mipmap.icon_collage, R.mipmap.icon_myalbum};
    ...
    private void a(ViewPager viewPager) {
        ...
        aVar.a(new SelectCollageFragment(), "COLLAGE");
        aVar.a(new MyAlbumFragment(), "MY ALBUM");
