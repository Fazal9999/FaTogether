package com.kptech.peps.Editor.videotomp3;
        ...
        FFmpeg.executeAsync(ffmpegCommand, new ExecuteCallback() {
            ...
            public void apply(final long executionId, final int returnCode) {
                ...
                if (returnCode == RETURN_CODE_SUCCESS) {
                    ...
                    Log.i("mp3",VideoToMP3ConverterActivity.this.c);
                    Toast.makeText(VideoToMP3ConverterActivity.this, "Done", 51).show();
                    ...
                    Intent mpintent=new Intent(VideoToMP3ConverterActivity.this, CreateHomePostActivity.class);
                    mpintent.putExtra(Const.MP,VideoToMP3ConverterActivity.this.c);
    ...
    public void initVideoView() {
        ...
        this.F.setOnPreparedListener(new OnPreparedListener() {
            public void onPrepared(MediaPlayer mediaPlayer) {
                VideoToMP3ConverterActivity.this.E.setSeekBarChangeListener(new VideoSliceSeekBar.SeekBarChangeListener() {
