package com.kptech.peps.Editor.fastmotionvideo;
        ...
        FFmpeg.executeAsync(ffmpegCommand, new ExecuteCallback() {
            ...
            public void apply(final long executionId, final int returnCode) {
                ...
                if (returnCode == RETURN_CODE_SUCCESS) {
                    ...
                    progressDialog.dismiss();
                    Intent fastintent=new Intent(FastMotionVideoActivity.this, CreateHomePostActivity.class);
                    fastintent.putExtra(Const.VIDEO,FastMotionVideoActivity.this.b);
