...
public class AudioCompressorAdapter extends BaseAdapter {
    ...
    private class a {
        ...
        a(AudioCompressorAdapter audioCompressorAdapter, AudioCompressorAdapter audioCompressorAdapter2, a aVar) {
            this();
        }
    }
    ...
    AudioCompressorAdapter(Context context, ArrayList<String> arrayList, int i) {
        this.d = context;
